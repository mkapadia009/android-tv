...
public class FeedGameViewAllHolder extends KRecyclerViewHolder {
    View view;
    CardView cvParent;
    ...
    public FeedGameViewAllHolder(View itemView) {
        super(itemView);
        view = itemView;
    ...
    protected void setData(Context context, Object itemObject) {
        ...
        if (itemObject instanceof GameData) {
            ...
            //int devicewidth = (int) (displaymetrics.widthPixels / 1.0);
