...
public class LiveNowViewHolder extends KRecyclerViewHolder {
    ...
    public LiveNowViewHolder(View itemView, boolean isLive) {
        super(itemView);
        view = itemView;
    ...
    protected void setData(Context context, Object itemObject) {
        ...
        if (itemObject instanceof LiveNowData) {
            ...
            tvViewCount.setText(((LiveNowData) itemObject).viewers);
