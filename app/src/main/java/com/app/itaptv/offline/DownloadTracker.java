...
public class DownloadTracker {
    ...
    public void toggleDownload(
        ...
        if (download != null && download.state != Download.STATE_FAILED) {
            DownloadService.sendRemoveDownload(
                    context, OfflineDownloadService.class, download.request.id, /* foreground= */ false);
        } else {
    ...
    private final class StartDownloadDialogHelper
        ...
        public void onPrepared(DownloadHelper helper) {
            ...
            if (Util.SDK_INT < 18) {
                Toast.makeText(context, R.string.download_not_supported, Toast.LENGTH_LONG)
                        .show();
            ...
            if (!hasSchemaData(format.drmInitData)) {
                Toast.makeText(context, R.string.exo_download_failed, Toast.LENGTH_LONG)
                        .show();
                Log.e(
                        TAG,
        ...
        public void onPrepareError(DownloadHelper helper, IOException e) {
            ...
            int toastStringId =
                    isLiveContent ? R.string.download_not_supported : R.string.download_failed;
            String logMessage =
        ...
        private void startDownload(DownloadRequest downloadRequest) {
            DownloadService.sendAddDownload(
                    context, OfflineDownloadService.class, downloadRequest, /* foreground= */ false);
        }
