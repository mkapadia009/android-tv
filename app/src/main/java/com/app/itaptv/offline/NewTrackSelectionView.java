package com.app.itaptv.offline;
...
public class NewTrackSelectionView extends LinearLayout {

    /** Listener for changes to the selected tracks. */
    public interface NewTrackSelectionListener {
        /**
    ...
    @Nullable private NewTrackSelectionListener listener;

    /** Creates a track selection view. */
    public NewTrackSelectionView(Context context) {
        this(context, null);
    }

    /** Creates a track selection view. */
    public NewTrackSelectionView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    /** Creates a track selection view. */
    @SuppressWarnings("nullness")
    public NewTrackSelectionView(
    ...
    public void init(
            ...
            @Nullable NewTrackSelectionListener listener) {
    ...
    private class ComponentListener implements OnClickListener {
        ...
        public void onClick(View view) {
            NewTrackSelectionView.this.onClick(view);
        }
    }
}
