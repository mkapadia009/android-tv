...
public class LiveNowData implements Parcelable, Serializable {
    ...
    public LiveNowData(JSONObject jsonObject) {
        try {
            ...
            liveStreamUrl = jsonObject.has("hls_url") ? jsonObject.getString("hls_url") : "";
            shareUrl = jsonObject.has("share_url") ? jsonObject.getString("share_url") : "";
    ...
    protected LiveNowData(Parcel in) {
        id = in.readInt();
        comments = in.readInt();
        ...
        liveStreamUrl = in.readString();
        shareUrl = in.readString();
    }

    public static final Creator<LiveNowData> CREATOR = new Creator<LiveNowData>() {
        @Override
        public LiveNowData createFromParcel(Parcel in) {
            return new LiveNowData(in);
        }

        @Override
        public LiveNowData[] newArray(int size) {
            return new LiveNowData[size];
        }
    };
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeString(liveStreamUrl);
