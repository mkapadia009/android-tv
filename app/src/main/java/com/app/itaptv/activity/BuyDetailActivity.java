 ...
 */
public class BuyDetailActivity extends BaseActivity implements TabLayout.BaseOnTabSelectedListener, PaymentResultListener, ExternalWalletListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (getIntent() != null) {
            ...
            if (feedContentData != null) {
                ...
                if (getIntent().hasExtra(FROM_SLIDER)) {
    ...
    public void playTeaser(View view) {
        HomeActivity.getInstance().pausePlayer();
        /*startActivity(new Intent(this, TeaserActivity.class).putExtra(CONTENT_DATA, feedContentData));*/
        ...
        if (sd != null && sd.allow_rental != null) {
            if (sd.allow_rental.equalsIgnoreCase(Constant.YES)) {
                startActivityForResult(new Intent(this, TeaserActivity.class).putExtra(CONTENT_DATA, feedContentData).putExtra(REQUEST_CODE_EXTRA, REQUEST_CODE_WATCH), REQUEST_CODE_WATCH);
            } else {
                startActivityForResult(new Intent(this, TeaserActivity.class).putExtra(CONTENT_DATA, feedContentData).putExtra(REQUEST_CODE_EXTRA, REQUEST_CODE_BUY), REQUEST_CODE_BUY);
            }
        }
    }
    ...
    private void setAudioPostLayout() {
        View viewContent = View.inflate(this, R.layout.layout_buy_detail_without_coord, null);
        viewContentLoader = View.inflate(this, R.layout.loader, null);
    ...
    private void setTabListLayout() {
        View viewContent = View.inflate(this, R.layout.layout_buy_detail_with_coord, null);
        viewContentLoader = View.inflate(this, R.layout.loader, null);
        viewContentLoader.setLayoutParams(new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.MATCH_PARENT));
    ...
    private void setTvPostLayout() {
        View viewContent = View.inflate(this, R.layout.layout_buy_detail_tv, null);
        viewContentLoader = View.inflate(this, R.layout.loader, null);
        viewContentLoader.setLayoutParams(new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.MATCH_PARENT));
        viewContentLoader.setVisibility(View.GONE);
        rlParent.addView(viewContent);
        rlParent.addView(viewContentLoader);
        llSeasons = findViewById(R.id.llSeasons);
        ...
        llSeasons.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivityForResult(new Intent(BuyDetailActivity.this, SeasonsTvFragment.class).putExtra(ViewMoreActivity.CONTEXT_TYPE, "").putExtra(SeasonsTvFragment.Companion.getPOST_TYPE(), postType)
                        .putExtra(SeasonsTvFragment.Companion.getSERIES_ID(), seriesId).putParcelableArrayListExtra(SeasonsTvFragment.Companion.getSEASON_ID(), feedContentData.arrayListSeasonData).putExtra(SeasonsTvFragment.Companion.getISWATCHED(), String.valueOf(feedContentData.iswatchlisted)), 101);
            }
        });
    ...
    private void init() {
        ...
        playNow = findViewById(R.id.btPlayNow);
        tvRupees = findViewById(R.id.tvRupees);
        tvCoinsTotal = findViewById(R.id.tvCoinsTotal);
        ...
        tvTeaserDescription = findViewById(R.id.tvTeaserDescription);
        tvSaving = findViewById(R.id.tvSaving);
        llCoins = findViewById(R.id.llCoins);
        //llOfferPrice = findViewById(R.id.llOfferPrice);
        ivPlayBtn = findViewById(R.id.ivPlay);
        llTeaser = findViewById(R.id.llTeaser);
        ivPlayBtn.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
            public void onFocusChange(View view, boolean b) {
                if (view.hasFocus()) {
                    llTeaser.setBackground(getDrawable(R.drawable.highlight_text_field));
                } else {
        ...
        rlCoinsPay = findViewById(R.id.rlCoinsPay);
        tvCoinsPayment = findViewById(R.id.tvCoinsPayment);
        ...
        rlPayTm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (feedContentData != null) {
                    ...
                    Utility.showError(getString(R.string.product_id_missing), BuyDetailActivity.this);
                }
            }
        });
        ...
        rlSubscribe.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivityForResult(new Intent(BuyDetailActivity.this, PremiumActivity.class).putExtra("title", getResources().getString(R.string.label_premium)), REQUEST_CODE);
            }
        });
    ...
    private void setBasicInfo() {
        if (feedContentData != null) {
            ...
            Glide.with(this)
                    .load(feedContentData.teaserImage)
                    .diskCacheStrategy(DiskCacheStrategy.ALL)
                    .transition(DrawableTransitionOptions.withCrossFade())
                    .into(ivTeaserImage);

            ivFeedImage.setBackgroundColor(ContextCompat.getColor(getApplicationContext(), R.color.full_transparent));
            Glide.with(this)
    ...
    private void setPriceData(int position) {
        if (feedContentData.arrayListPriceData != null) {
            ...
            for (Drawable drawable : tvDuration.getCompoundDrawables()) {
                if (drawable != null) {
                    drawable.mutate().setColorFilter(new PorterDuffColorFilter(ContextCompat.getColor(this, R.color.colorAccent), PorterDuff.Mode.SRC_IN));
                }
            }
    ...
    public void showDuration(View view) {
        ...
        startActivityForResult(new Intent(this, DurationActivity.class)
                .putExtra(DurationActivity.PRICE_DATA, arrayListPriceData)
                .putExtra(DurationActivity.SELECTED_DURATION, selectedDuration), REQUEST_CODE);
    }
    ...
    private void viewPurchases() {
        if (alertDialog != null && alertDialog.isShowing()) {
            ...
            setResult(Activity.RESULT_OK, returnIntent);*/
            startActivity(new Intent(BuyDetailActivity.this, PurchasesActivity.class).putExtra("title", getResources().getString(R.string.label_purchases)));
            finish();
        }
    }
               ...
               /* if (costType.equalsIgnoreCase(PriceData.COST_TYPE_COINS)) {
                ...
                if (rlCoinsPay.getVisibility() == View.VISIBLE) {
                    ...
                    if (coinsForEntry <= walletBalance) {
                        ...
                        startActivity(new Intent(BuyDetailActivity.this, PremiumActivity.class).putExtra("title", getResources().getString(R.string.label_premium)));
                    }
                } else {
                    startActivity(new Intent(BuyDetailActivity.this, PremiumActivity.class).putExtra("title", getResources().getString(R.string.label_premium)));
                }
    ...
    private void getPostData() {
        try {
            ...
            APIRequest apiRequest = new APIRequest(Url.GET_POST_BY_ID + "&ID=" + feedContentData.postId, Request.Method.GET, params, null, this);
                        ...
                        try {
                            ...
                            if (sd != null && sd.allow_rental != null) {
                                if (sd.allow_rental.equalsIgnoreCase(Constant.YES)) {
                                    ...
                                    if (!feedContentData.isTrailer && llSeasons != null) {
    ...
    public void razorpayPrepayment(String productId, int pricing_option, String screenType1) {
        try {
            ...
            APIRequest apiRequest = new APIRequest(Url.INITIATE_ORDER, Request.Method.POST, params, null, this);
            apiRequest.showLoader = true;
            APIManager.request(apiRequest, new APIResponse() {
                @Override
                public void onResponse(String response, Exception error, Map<String, String> headers, int statusCode) {
                    if (error == null) {
                        ...
                        Utility.showError(error.toString(), BuyDetailActivity.this);
                    }
                }
            });
        } catch (Exception e) {
            Utility.showError(getString(R.string.failed_to_initiate_payment), BuyDetailActivity.this);
        }
    }
    ...
    private void handleRazorpayPrepaymentResponse(@Nullable String
                                                          response, @Nullable Exception error) {
        try {
            if (error != null) {
                Utility.showError(error.getMessage(), BuyDetailActivity.this);
            } else {
                if (response != null) {
                    JSONObject jsonObjectResponse = new JSONObject(response);
                    String type = jsonObjectResponse.has("type") ? jsonObjectResponse.getString("type") : "";
    ...
    private void handleCoinsPayPrepaymentResponse(@Nullable String
                                                          response, @Nullable Exception error, String productId) {
        try {
            if (error != null) {
                Utility.showError(error.getMessage(), BuyDetailActivity.this);
            } else {
                    ...
                    if (type.equalsIgnoreCase("error")) {
                        ...
                        if (status.equalsIgnoreCase("SUCCESS")) {
                            ...
                            if (screenType.equalsIgnoreCase(EpisodePlaylistTabFragment.FROMSEASONTAB)) {
                                ...
                                LocalStorage.savePurchasedArrayList(purchasedList, "savedPurchased", getApplicationContext());
                                showBuySuccessDialog();
                            }
                        }
                    }
    ...
    private void razorpayPostPayment(String itap_order_id, String razorpay_order_id) {
        try {
            ...
            APIRequest apiRequest = new APIRequest(Url.COMPLETE_ORDER, Request.Method.POST, params, null, this);
                    ...
                    try {
                        if (error == null) {
                            ...
                            if (type.equalsIgnoreCase("error")) {
                                ...
                                String message = jsonObjectResponse.has("msg") ? jsonObjectResponse.getString("msg") : APIManager.GENERIC_API_ERROR_MESSAGE;
                                Utility.showError(message, BuyDetailActivity.this);
                                ...
                                if (msg.getString("status").equalsIgnoreCase("success")) {
                                    ...
                                    Utility.showError(msg.getString("display_message"), BuyDetailActivity.this);
                                }
                            }
                        } else {
                            Utility.showError(error.toString(), BuyDetailActivity.this);
            ...
            Utility.showError(getString(R.string.failed_to_complete_payment), BuyDetailActivity.this);
        }
    }
    ...
    public void onExternalWalletSelected(String walletName, PaymentData paymentData) {
        ...
        if (walletName.equals("paytm")) {
            ...
            if (feedContentData != null) {
                ...
                Utility.showError(getString(R.string.product_id_missing), this);
            }
        }
    }
    ...
    private void handlePaytmPrepaymentResponse(@Nullable String response, @Nullable Exception
            error) {
        try {
            if (error != null) {
                Utility.showError(error.getMessage(), BuyDetailActivity.this);
    ...
    private void initiatePaytm(JSONObject object) {
        ...
        try {
            if (!object.has("paytmParams")) {
                Utility.showError(getString(R.string.order_request_parameters_not_received), BuyDetailActivity.this);
            } else {
                ...
                Service.startPaymentTransaction(BuyDetailActivity.this, true, true, new PaytmPaymentTransactionCallback() {
                    ...
                    public void onTransactionResponse(Bundle inResponse) {
                        ...
                        if (inResponse.getString("STATUS").equalsIgnoreCase("TXN_SUCCESS")) {
                            ...
                            Utility.showError((inResponse.containsKey("RESPMSG") ? inResponse.getString("RESPMSG") : getString(R.string.transaction_failed)), BuyDetailActivity.this);
                        }
                    }
    ...
    private void showError(@Nullable String errorMessage) {
        ...
        AlertUtils.showAlert(getString(R.string.label_error), errorMessage, null, BuyDetailActivity.this, null);
    }
    ...
    private void startManageSubscriptions() {
        ...
        try {
            ...
            APIRequest apiRequest = new APIRequest(Url.FETCH_SUBSCRIPTIONS_URL, Request.Method.POST, params, null, BuyDetailActivity.this);
            apiRequest.showLoader = true;
            APIManager.request(apiRequest, new APIResponse() {
                @Override
                public void onResponse(String response, Exception error, Map<String, String> headers, int statusCode) {
                        ...
                        try {
                            if (response != null) {
                                ...
                                if (type.equalsIgnoreCase("error")) {
                                    ...
                                    startActivityForResult(new Intent(BuyDetailActivity.this, BrowserActivity.class).putExtra("title", "Premium").putExtra("posturl", subscriptionsUrl), REQUEST_CODE_PREMIUM);
                                }
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
    ...
    protected void onResume() {
        super.onResume();
        if (getIntent() != null && isRefreshRequired) {
            isRefreshRequired = false;
            finish();
